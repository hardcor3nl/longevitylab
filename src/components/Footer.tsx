...
export function Footer() {
  ...
  return (
    <footer className="bg-surface border-t border-border">
      {/* Top accent line */}
      <div className="h-px w-full" style={{ background: 'linear-gradient(to right, transparent, var(--green-bright), transparent)', opacity: 0.4 }} />
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-10 mb-14">
          ...
          <div className="col-span-2 md:col-span-2">
            ...
            <p className="text-muted text-sm leading-relaxed mb-5 max-w-[260px]">
              ...
              Never sponsored by supplement companies.
            </p>
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <a href="https://github.com/hardcor3nl/longevitylab" target="_blank" rel="noopener noreferrer"
                className="p-2 rounded-lg border border-border hover:border-green/40 hover:bg-green/5 text-muted hover:text-ink transition-all duration-150 cursor-pointer"
          ...
          {Object.entries(links).map(([section, items]) => (
            <div key={section}>
              <h4 className="font-mono text-[10px] uppercase tracking-[0.12em] text-muted/70 mb-4">{section}</h4>
        ...
        <div className="border-t border-border pt-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex flex-wrap gap-x-5 gap-y-1 text-xs text-muted font-mono">
              ...
              <Link href="/contact"           className="hover:text-ink transition-colors duration-150">Contact</Link>
            </div>
