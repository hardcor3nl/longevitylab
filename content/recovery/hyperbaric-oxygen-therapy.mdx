...
products:
  ...
  - name: "Portable Mild Hyperbaric Chamber"
    ...
    badge: "Budget"
    pros:
      - "Meaningfully lower upfront cost than premium FDA-registered brands"
      - "Same 1.3 ATA pressure class as premium soft chambers"
      - "Lower-commitment way to trial the format"
    cons:
      - "Build quality and safety certification vary significantly by listing"
      - "Not FDA-registered in most cases — verify before buying"
      - "Same evidence limitations as all mild hyperbaric use"
