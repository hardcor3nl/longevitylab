...
### 1. Time in Range (TIR)
The percentage of time your glucose stays between 70–140 mg/dL (for non-diabetics). Optimal: **>90% time in range**.

Most healthy young adults achieve >95% TIR. Values below 80% suggest metabolic dysfunction even if fasting glucose appears normal.

### 2. Glucose Variability (CV%)
How much your glucose fluctuates. Measured as coefficient of variation. **CV <25%** is considered stable.
...
### 3. Mean Glucose
Your average over the wear period. For non-diabetics, optimal mean is **<100 mg/dL**, ideally 80–95 mg/dL.

### 4. Post-Meal Peak
The highest point your glucose reaches after a meal. For longevity:
- **<140 mg/dL:** Excellent response
- **140–180 mg/dL:** Moderate spike — watch this food
- **>180 mg/dL:** Significant — reduce portion or pair with protein/fat
...
**Dawn phenomenon:** Many people wake with glucose already elevated (80–100 mg/dL) due to cortisol morning spike. This is normal; alarming values (>110) are not.
