...
Worth noting clearly: this is a commercial product from Johnson's own company, not an independent measurement service. It competes directly with services discussed in our [longevity labs comparison](/best/best-longevity-labs). If you're specifically interested in the epigenetic/DunedinPACE-style testing Johnson uses for his headline biological-age numbers, that's a different product category from his own biomarker panel service — worth not conflating the two when deciding what to buy.
